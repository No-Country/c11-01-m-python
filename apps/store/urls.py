...
from apps.store.views import product_detail, category_detail, search, add_to_cart, cart_view, remove_from_cart, change_quantity, add_quantity, checkout, invoice
